      ...
      >
        ...
        >
          ...
          <div className="roadmap-item__content bg-black/70 hover:shadow-[0_0_15px_5px_rgba(56,182,255,0.3)]">
            <div className={`bg-iceblue w-fit transition transform px-2 ${isEven ? 'absolute left-0 md:ml-0 ml-[25px] -translate-y-4 rounded-tl-md' : 'absolute md:right-0 md:rounded-tr-md -translate-x-4 md:-translate-x-0 -translate-y-4 md:rounded-tl-none rounded-tl-md'}`}>
